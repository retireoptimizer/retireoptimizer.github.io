  ...
  return (
    <div>
      ...
      <FieldTable rows={[
        ...
        ["Muni Bond", "Federally tax-exempt (IRC §103) but included in SS provisional income, ACA MAGI, and IRMAA MAGI. State taxable % controls whether the interest is taxable to your resident state (100% for out-of-state bonds, 0% for in-state).", "Bond ladder held outside your brokerage portfolio"],
      ...
      <Tip>
        <strong>Portfolio yield vs. income stream:</strong> use the <em>Tax-Exempt Yield</em> field
        in the Portfolio section for muni interest generated by bonds held inside your brokerage
        balance. Use a Muni Bond stream only for a bond ladder whose principal is outside your
        tracked portfolio. Entering both double-counts the income.
      </Tip>
      ...
      <FieldTable rows={[
        ...
        ["↳ Div / Interest Yield", "The portion of Taxable Return paid out annually as taxable dividends or interest. Taxed each year — qualified dividends at LTCG rates, ordinary dividends and interest at your income rate. Reinvested into cost basis, reducing future capital gains on withdrawal. Leave at 0 to treat all growth as price appreciation.", "1.5%"],
      ...
      <Tip>
        <strong>Why the optimizer may recommend more Roth conversions than you expect:</strong> Max End Balance now maximizes the <em>tax-adjusted</em> ending balance — every dollar of Roth is worth more than every dollar of pre-tax because it carries no embedded income-tax liability. Paying conversion tax now to grow a clean Roth looks expensive year-by-year but improves the metric the optimizer is scoring. To see what the rates are set to, or to restore raw-balance optimization, go to Portfolio settings → End-Balance Tax Adjustment.
      </Tip>
